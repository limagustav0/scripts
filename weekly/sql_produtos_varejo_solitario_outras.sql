...
WHERE nf.nop IN ("6.102","6.404","BLACKFRIDAY","CAMPANHA","VENDA","VENDA_S_ESTOQUE","WORKSHOP","BONIFICADO","BONI_COMPRA","PROMOCAO","PROMO_BLACK","ENXOVAL")
AND nfitem.cod_empresa IN (4,5)
AND nf.situacao < 100
AND nf.dt_emissao > "2021-01-01" 
AND vendedor.cod_colaborador IN (18,52,56,73,159,161)

INTO OUTFILE 'csv/produtos_varejo_solitario_outras_marcas.csv'
CHARACTER SET utf8
