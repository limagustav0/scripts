...
LEFT JOIN cd_cliente AS cliente ON (cliente.cod_cliente = nf.cod_cliente AND  cliente.cod_colaborador IN (385, 3342, 3346, 3345, 3344, 3369, 3375, 3349, 3374, 3376, 3358, 3354, 3366, 3348, 3370))
...
WHERE nf.nop IN ("6.102","6.404","BLACKFRIDAY","CAMPANHA","TRUSS LOVER","VENDA","VENDA_S_ESTOQUE","WORKSHOP","BONIFICADO", "BONIFICADO_F","BONI_COMPRA","PROMOCAO","PROMO_BLACK","ENXOVAL")
AND nfitem.cod_empresa IN (10,11)
AND nf.situacao < 100
AND nf.dt_emissao > "2021-01-01" 
AND vendedor.cod_colaborador IN (378, 385, 3342, 3346, 3345, 3344, 3369, 3375, 3349, 3374, 3376, 3358, 3354, 3366, 3348, 3370)

INTO OUTFILE 'csv/produtos_suprir.csv'
CHARACTER SET utf8
