...
ALTER TABLE `vd_nota_fiscal_item`
  ADD COLUMN `vl_tb_kami` double(20,10) NULL DEFAULT 0; #valor real padrão do produto
ALTER TABLE `vd_nota_fiscal_item`
  ADD COLUMN `vl_total_item_tb_kami` double(20,10) NULL DEFAULT 0; #valor vl_tb_kami * qtde
ALTER TABLE `vd_nota_fiscal_item`
  ADD COLUMN `ano_nota` varchar(20) NULL DEFAULT NULL;

ALTER TABLE `vd_nota_fiscal`
  ADD COLUMN `vl_total_tb_kami` double(20,10) NULL DEFAULT 0; #valor total vendido caso usasse a tabela padrão
...
#efetua o calculo do valor total da nota fiscal
...
#efetua o calculo do valor total do pedido
UPDATE `vd_pedido` 
